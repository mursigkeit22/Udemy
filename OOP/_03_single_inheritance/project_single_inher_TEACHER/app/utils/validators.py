...
# docstrings look this way cause I chose "Google" in Settings - Python Integrated Tools - Docstrings
def validate_integer(arg_name, arg_value, min_value=None,
                     max_value=None, custom_min_message=None, custom_max_message=None):
    """
